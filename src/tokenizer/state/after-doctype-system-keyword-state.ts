...
// ↪ U+000C FORM FEED (FF)
// ↪ U+0020 SPACE
// Switch to the before DOCTYPE system identifier state p1115.
// ↪ U+0022 QUOTATION MARK (")
// This is a missing-whitespace-after-doctype-system-keyword
// p1079 parse error p1077. Set the DOCTYPE token's system identifier to
// the empty string (not missing), then switch to the DOCTYPE system identifier (double-quoted) state p1116.
// ↪ U+0027 APOSTROPHE (')
// This is a missing-whitespace-after-doctype-system-keyword
// p1079 parse error p1077. Set the DOCTYPE token's system identifier to
// the empty string (not missing), then switch to the DOCTYPE system identifier (single-quoted) state p1116.
// ↪ U+003E GREATER-THAN SIGN (>)
// This is a missing-doctype-system-identifier p1079 parse error p1077. Set the DOCTYPE token's force-quirks flag p1093 to on. Switch to
