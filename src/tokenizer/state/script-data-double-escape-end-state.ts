...
// If the temporary buffer p1093 is the string "script", then switch to the script data escaped state p1099. Otherwise, switch to the
// script data double escaped state p1102. Emit the current input character p1088 as a character token.
// ↪ ASCII upper alpha
